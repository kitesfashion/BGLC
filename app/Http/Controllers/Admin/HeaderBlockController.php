        ...
        if(count($request->all()) > 0){
            if($headerInfo){
                if (isset($request->firstHomeImage)) {
                    ...
                    $firstHomeImage = \App\HelperClass::UploadImage($request->firstHomeImage,'events','images/events/home/');
                    $headerInfo->update( [
                ...
                if (isset($request->firstInnerImage)) {
                     ...
                     $firstInnerImage = \App\HelperClass::UploadImage($request->firstInnerImage,'events','images/events/inner_page/');
                    $headerInfo->update( [
                ...
                $headerInfo->update( [
                 ...
                 if (isset($request->firstHomeImage)) {
                    $firstHomeImage = \App\HelperClass::UploadImage($request->firstHomeImage,'header_block','images/header_block/home/');
                }

                 if (isset($request->firstInnerImage)) {
                    $firstInnerImage = \App\HelperClass::UploadImage($request->firstInnerImage,'header_block','images/header_block/inner_page/');
                }
