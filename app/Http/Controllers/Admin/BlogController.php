    ...
    public function status(Request $request)
    {
     ...
     public function saveblog(Request $request){
        if (isset($request->firstHomeImage)) {
            $firstHomeImage = \App\HelperClass::UploadImage($request->firstHomeImage,'blogs','images/blogs/home/');
        }

         if (isset($request->firstInnerImage)) {
            $firstInnerImage = \App\HelperClass::UploadImage($request->firstInnerImage,'blogs','images/blogs/inner_page/');
        }
