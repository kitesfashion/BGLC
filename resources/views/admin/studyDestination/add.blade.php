...
<?php
    use App\Article;
?>
<form class="form-horizontal" action="{{ route('studyDestination.add') }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('parent_id') ? ' has-danger' : '' }}">
                <label for="parent_id">Destination Parent</label>
        ...
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                ...
                <input type="text" class="form-control form-control-danger" placeholder="destination name" name="name" value="{{ old('name') }}" required="">
                @if ($errors->has('name'))
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('firstHomeTitle') ? ' has-danger' : '' }}">
                ...
                <input type="text" class="form-control form-control-danger" placeholder="title 1" name="firstHomeTitle" value="{{ old('firstHomeTitle') }}">
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="form-group {{ $errors->has('buttonName') ? ' has-danger' : '' }}">
                        ...
                        <input type="text"  name="buttonName" class="form-control" value="{{ old('buttonName') }}">
