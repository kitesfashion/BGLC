        ...
        <div class="row">
           <div class="col-md-6">
                <div class="form-group {{ $errors->has('officeLocation') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control form-control-danger" placeholder="Bangladesh Head Office" name="officeLocation" value="{{ @$contactAddress->officeLocation }}">
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('officeName') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control form-control-danger" placeholder="Demo Company Limited" name="officeName" value="{{ @$contactAddress->officeName }}">
        ...
        <div class="row">
           <div class="col-md-6">
                <div class="form-group {{ $errors->has('addressTitle1') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control form-control-danger" placeholder=" Title 1" name="addressTitle1" value="{{ @$contactAddress->addressTitle1 }}">
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('image') ? ' has-danger' : '' }}">
                    ...
                    @if (file_exists(@$contactAddress->image))
                        <img src="{{asset('/').@$contactAddress->image}}" style="height: 90px;">
                    @else
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('address1') ? ' has-danger' : '' }}">
                    ...
                    <textarea class="form-control form-control-danger tinymce" name="address1">{{ $contactAddress->address1 }}</textarea>
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('address2') ? ' has-danger' : '' }}">
                    ...
                    <textarea class="form-control form-control-danger tinymce" name="address2">{{ $contactAddress->address2 }}</textarea>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('email1') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control form-control-danger" placeholder="Email Address" name="email1" value="{{ $contactAddress->email1 }}">
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('email2') ? ' has-danger' : '' }}">
                    ...
                    <input type="email" class="form-control form-control-danger" placeholder="Email Address" name="email2" value="{{ $contactAddress->email2 }}">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('mobile1') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control form-control-danger" placeholder="First Phone Number" name="mobile1" value="{{ $contactAddress->mobile1 }}">
