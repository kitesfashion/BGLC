                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('siteLogo') ? ' has-danger' : '' }}">
                            ...
                            <span class="imageSizeInfo">
                                /* Standard Image Size: 150*100 px */
                            </span><br>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('sitefavIcon') ? ' has-danger' : '' }}">
                            ...
                            <span class="imageSizeInfo">/* Standard Image Size : 100*100 px */ <br></span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('mobile1') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" class="form-control form-control-danger" placeholder="First Phone Number" name="mobile1" value="{{ @$settings->mobile1 }}">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('siteAddress1') ? ' has-danger' : '' }}">
                    ...
                    <textarea class="form-control form-control-danger" name="siteAddress1">{{ @$settings->siteAddress1 }}</textarea>
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('siteAddress2') ? ' has-danger' : '' }}">
                    ...
                    <textarea class="form-control form-control-danger" name="siteAddress2">{{ @$settings->siteAddress2 }}</textarea>
