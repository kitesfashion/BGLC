...
<?php
    use App\Article;
?>
<form class="form-horizontal" action="{{ route('services.add') }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
        ...
        {{-- <div class="col-md-6">
         ...
         <div class="col-md-6">
            <div class="form-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                ...
                <input type="text" class="form-control form-control-danger" placeholder="service name" name="name" value="{{ old('name') }}" required="">
                @if ($errors->has('name'))
